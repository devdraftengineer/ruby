...
This directory contains example code demonstrating how to use the Ruby SDK.

## Available Examples

### Health Examples

- **File**: [`health_check.rb`](./health_check.rb)
...
- **File**: [`customers.rb`](./customers.rb)
