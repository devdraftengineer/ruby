...
module Devdraft
  class AllBalancesResponse < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if @eurc.nil?
        invalid_properties.push('invalid value for "eurc", eurc cannot be nil.')
      end

      if @total_usd_value.nil?
        invalid_properties.push('invalid value for "total_usd_value", total_usd_value cannot be nil.')
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          usdc == o.usdc &&
          eurc == o.eurc &&
          total_usd_value == o.total_usd_value
    end
    ...
    def hash
      [usdc, eurc, total_usd_value].hash
    end
