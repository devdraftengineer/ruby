...
# Unit tests for Devdraft::HealthResponseDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Devdraft::HealthResponseDto do
  #let(:instance) { Devdraft::HealthResponseDto.new }

  describe 'test an instance of HealthResponseDto' do
    it 'should create an instance of HealthResponseDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Devdraft::HealthResponseDto)
    end
  end
