...
# Unit tests for Devdraft::UpdateCustomerDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Devdraft::UpdateCustomerDto do
  #let(:instance) { Devdraft::UpdateCustomerDto.new }

  describe 'test an instance of UpdateCustomerDto' do
    it 'should create an instance of UpdateCustomerDto' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Devdraft::UpdateCustomerDto)
    end
  end
